      ...
      Object.entries(data as Record<string, Record<string, unknown>>).forEach(([key, value]) => {
        ...
        if (forwardedBy.includes("Secretary") && !seenAwdRefNums.has(awdRefNum)) {
          ...
          transformedData.push({
            ...
            origioffice: (value.originatingOffice as string) || "N/A",
            fsisrefnum: (value.fsisReferenceNumber as string) || "N/A",
            forwardby: forwardedBy,
            forwardto: (value.forwardedTo as string) || "N/A",
            remarks: (value.remarks as string) || "N/A",
          });
        }
      });
