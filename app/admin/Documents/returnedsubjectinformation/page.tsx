...
export default function SubjectInformation() {
  ...
  useEffect(() => {
    ...
    const docQuery = query(ref(database, "returned"), orderByChild("awdReferenceNumber"), equalTo(awdrefnu));
          ...
          <div className="pl-12 pt-8">
            ...
            <div className="grid grid-cols-2 gap-6 pl-12">
              {[ 
                ...
                { label: "AWD Date Received", value: subjectData.dateTimeSubmitted },
